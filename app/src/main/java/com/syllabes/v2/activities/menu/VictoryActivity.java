...
import com.syllabes.v2.activities.games.SoundSyllabesActivity;
import com.syllabes.v2.activities.games.SpeakSyllabesActivity;
import com.syllabes.v2.activities.games.SyllaBubbleActivity;
...
public class VictoryActivity extends AbstractActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (response != null) {
            ((ImageView) findViewById(R.id.image_id_victory)).setImageResource(getResources().getIdentifier("img_" + response, "drawable", getPackageName()));
        }
