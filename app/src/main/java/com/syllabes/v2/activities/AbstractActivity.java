...
package com.syllabes.v2.activities;
...
import com.syllabes.v2.activities.menu.GamesChoiceActivity;
import com.syllabes.v2.activities.menu.SyllabesActivity;
import com.syllabes.v2.res.Word;
...
public abstract class AbstractActivity extends Activity {
    ...
    public void onBackPressed() {
        ...
        overridePendingTransition(R.anim.fadein, R.anim.fadeout);
        Player.stop();
        if (this instanceof GamesChoiceActivity || this instanceof SyllabesActivity) {
